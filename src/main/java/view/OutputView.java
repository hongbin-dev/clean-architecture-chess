...
public class OutputView {
	...
	public static void printBoard(ChessGame gameManager) {
	...
	public static void printWinner(ChessGame gameManager) {
		System.out.printf("승자는 %s입니다!%n", gameManager.findWinner());
	}
}